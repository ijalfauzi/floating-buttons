...
<div id="floatingButtons" class="fixed right-4 flex flex-col space-y-2 z-50 transition-all duration-300 ease-in-out bottom-4">
    <button id="backToTopBtn" class="group flex items-center justify-center bg-green-600 text-white p-2 w-12 h-12 rounded-lg hover:bg-green-700 transition duration-300 transform hover:scale-105 shadow-lg opacity-0">
    ...
    <button id="whatsappBtn" class="group flex items-center justify-center bg-green-600 text-white p-2 w-12 h-12 rounded-lg hover:bg-green-700 transition duration-300 transform hover:scale-105 shadow-lg">
...
<div id="formPopup" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 p-4 backdrop-blur-sm">
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-md relative">
        <?php include FB_PLUGIN_DIR . 'templates/whatsapp-form.php'; ?>
    </div>
</div>